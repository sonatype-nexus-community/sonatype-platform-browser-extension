 ...
 */
import { RepoMavenApacheOrgRepo } from './repo-maven-apache-org'
...
export class Repo1MavenOrgRepo extends RepoMavenApacheOrgRepo {
    readonly id: RepositoryId = RepositoryId.REPO1_MAVEN_ORG

    readonly baseUrl: string = 'https://repo1.maven.org/maven2/'
}